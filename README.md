...
# Результаты и выводы
Реализованы три архитектуры с полной оценкой метрик. BiLSTM выигрывает за счёт правильной архитектуры для word-level задачи + оптимальных гиперпараметров.
